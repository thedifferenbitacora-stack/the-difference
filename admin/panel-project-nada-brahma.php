...
$defaults = [
    $prefix . 'title_text' => 'PROJECT NADA BRAHMA',
    ...
    $prefix . 'subtitle_text' => 'PROJECT NADA BRAHMA',
    ...
    $prefix . 'btn_main_text' => 'PROJECT NADA BRAHMA',
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (isset($_FILES[$prefix . 'logo'])) {
        $result = processFileUpload($_FILES[$prefix . 'logo'], 'image', 'project-nada-brahma', $imagesDir, $videosDir);
        if ($result) {
    ...
    if (saveConfig($configFile, $config)) {
        $mensaje .= "✅ Configuración de PROJECT NADA BRAHMA guardada.";
        $config = loadConfig($configFile);
        $config = array_merge($defaults, $config);
    }
}
...
<title>Panel PROJECT NADA BRAHMA</title>
<style>
...
<body>
<div class="container">
<h1>📄 Panel de PROJECT NADA BRAHMA</h1>
<p class="subtitle">Configuración de la página PROJECT NADA BRAHMA</p>
...
<a href="panel-project-nada-brahma.php" class="active">📄 PROJECT NADA BRAHMA</a>
